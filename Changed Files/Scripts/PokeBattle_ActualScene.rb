...
class PokemonDataBox < SpriteWrapper
  ...
  def refresh
    ...
    if @battler.isMega? && @battler.item==606 && $game_switches[457] ==  true
      imagepos.push(["Graphics/Pictures/Battle/battlePulseEvoBox.png",@spritebaseX+8,34,0,0,-1,-1])
    elsif @battler.isMega?
      imagepos.push(["Graphics/Pictures/Battle/battleMegaEvoBox.png",@spritebaseX+8,34,0,0,-1,-1])
    end
...
#      end
  ...
  def pbBackdrop
   ...
   #   backdrop="Mountain"
    ...
    # Field Effect for Online Battles
    if @battle.isOnline?
      $feoverride = $feonline
    end    
