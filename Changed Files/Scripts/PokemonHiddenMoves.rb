...
def Kernel.pbCut
  ...
  if !pbCheckHiddenMoveBadge(BADGEFORCUT,false) || (!$DEBUG && !movefinder && !$PokemonBag.pbHasItem?(:GOLDENAXE))
...
def Kernel.pbRockSmash
  ...
  movefinder = Kernel.pbCheckMove(move)
  if !pbCheckHiddenMoveBadge(BADGEFORROCKSMASH,false) || (!$DEBUG && !movefinder && !$PokemonBag.pbHasItem?(:GOLDENHAMMER))
...
def Kernel.pbStrength
  ...
  movefinder = Kernel.pbCheckMove(move)
  if !pbCheckHiddenMoveBadge(BADGEFORSTRENGTH,false) || (!$DEBUG && !movefinder && !$PokemonBag.pbHasItem?(:GOLDENGAUNTLET))
...
def Kernel.pbSurf
  ...
  movefinder = Kernel.pbCheckMove(move)
  if !pbCheckHiddenMoveBadge(BADGEFORSURF,false) || (!$DEBUG && !movefinder && !$PokemonBag.pbHasItem?(:GOLDENSURFBOARD))
    return false
  end
...
def Kernel.pbLavaSurf
  ...
  movefinder = Kernel.pbCheckMove(move)
  if !pbCheckHiddenMoveBadge(BADGEFORLAVASURF,false) || (!$DEBUG && !movefinder && !$PokemonBag.pbHasItem?(:GOLDENDRIFTBOARD))
    return false
  end
...
def Kernel.pbWaterfall
  ...
  movefinder = Kernel.pbCheckMove(move)
  if !pbCheckHiddenMoveBadge(BADGEFORWATERFALL,false) || (!$DEBUG && !movefinder && !$PokemonBag.pbHasItem?(:GOLDENJETPACK))
...
def Kernel.pbDive
  ...
  movefinder = Kernel.pbCheckMove(move)
  if !pbCheckHiddenMoveBadge(BADGEFORDIVE,false) || (!$DEBUG && !movefinder && !$PokemonBag.pbHasItem?(:GOLDENSCUBAGEAR))
...
def Kernel.pbRockClimb
  ...
  movefinder = Kernel.pbCheckMove(move)
  if !pbCheckHiddenMoveBadge(BADGEFORROCKCLIMB,false) || (!$DEBUG && !movefinder && !$PokemonBag.pbHasItem?(:GOLDENCLAWS))
