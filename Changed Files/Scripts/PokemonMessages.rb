...
def pbDisplayGoldWindow(msgwindow)
  ...
  goldwindow.setSkin("Graphics/Windowskins/speech hgss 1")
...
def pbDisplayCoinsWindow(msgwindow,goldwindow)
  ...
  coinwindow.setSkin("Graphics/Windowskins/speech hgss 1")
...
def Kernel.pbMessageDisplay(msgwindow,message,letterbyletter=true,commandProc=nil)
  ...
  textchunks=[]
  controls=[]
  while text[/(?:\\([WwFf]|[Ff][Ff]|[Tt][Ss]|[Cc][Ll]|[Mm][Ee]|[Ss][Ee]|[Ww][Tt]|[Ww][Tt][Nn][Pp]|[Cc][Hh])\[([^\]]*)\]|\\([Gg]|[Cc][Nn]|[Aa][Pp]|[Ww][Dd]|[Ww][Mm]|[Oo][Pp]|[Cc][Ll]|[Ww][Uu]|[\.]|[\|]|[\!]|[\x5E])())/i]
