...
def pbDisplayMail(mail,bearer=nil)
  ...
  viewport.z=99999
  addBackgroundPlane(sprites,"background","Party/mailbg",viewport)
...
class PokeSelectionSprite < SpriteWrapper
  ...
  def initialize(pokemon,index,viewport=nil)
    ...
    if active # Rounded panel
      @deselbitmap=AnimatedBitmap.new("Graphics/Pictures/Party/partyPanelRound")
      @selbitmap=AnimatedBitmap.new("Graphics/Pictures/Party/partyPanelRoundSel")
      @deselfntbitmap=AnimatedBitmap.new("Graphics/Pictures/Party/partyPanelRoundFnt")
      @selfntbitmap=AnimatedBitmap.new("Graphics/Pictures/Party/partyPanelRoundSelFnt")
      @deselswapbitmap=AnimatedBitmap.new("Graphics/Pictures/Party/partyPanelRoundSwap")
      @selswapbitmap=AnimatedBitmap.new("Graphics/Pictures/Party/partyPanelRoundSelSwap")
    else # Rectangular panel
      @deselbitmap=AnimatedBitmap.new("Graphics/Pictures/Party/partyPanelRect")
      @selbitmap=AnimatedBitmap.new("Graphics/Pictures/Party/partyPanelRectSel")
      @deselfntbitmap=AnimatedBitmap.new("Graphics/Pictures/Party/partyPanelRectFnt")
      @selfntbitmap=AnimatedBitmap.new("Graphics/Pictures/Party/partyPanelRectSelFnt")
      @deselswapbitmap=AnimatedBitmap.new("Graphics/Pictures/Party/partyPanelRectSwap")
      @selswapbitmap=AnimatedBitmap.new("Graphics/Pictures/Party/partyPanelRectSelSwap")
    end
    @spriteXOffset=28
    @spriteYOffset=0
    @pokeballXOffset=10
    ...
    @hpbarswap=AnimatedBitmap.new("Graphics/Pictures/Party/partyHPswap")
...
#### SARDINES - v17 - START
      ...
      if Input.trigger?(Input::X) && canswitch==1 && @activecmd!=cancelsprite
        pbPlayDecisionSE()
        return [1,@activecmd]
      end
      if Input.trigger?(Input::X) && canswitch==2
        return -1
      end
#### SARDINES - v17 - END
      if Input.trigger?(Input::B)
