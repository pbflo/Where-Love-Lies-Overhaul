...
# Returns true if it's day.
  def self.isDay?(time=nil)
    if $game_switches[37] || $game_switches[38]
      return true
    else
      return false
    end
...
def pbDayNightTint(object)
  ...
  elsif $game_switches[37] && $game_map && pbGetMetadata($game_map.map_id,MetadataOutdoor)
    tone = PBDayNight::HourlyTones[6]
    object.tone.set(tone.red,tone.green,tone.blue,tone.gray)
  elsif $game_switches[38] && $game_map && pbGetMetadata($game_map.map_id,MetadataOutdoor)
    tone = PBDayNight::HourlyTones[12]
    object.tone.set(tone.red,tone.green,tone.blue,tone.gray)
  elsif $game_switches[39] && $game_map && pbGetMetadata($game_map.map_id,MetadataOutdoor)
    tone = PBDayNight::HourlyTones[19]
    object.tone.set(tone.red,tone.green,tone.blue,tone.gray)
  elsif $game_switches[40] && $game_map && pbGetMetadata($game_map.map_id,MetadataOutdoor)
