...
def pbStartTrade(pokemonIndex,newpoke,nickname,trainerName,trainerGender=0,online=false)
  ...
  if $game_switches[540] == true
    ...
    pbDexDataOffset(dexdata,yourPokemon.species,21)
    eggsteps=dexdata.fgetw
    dexdata.close 
    yourPokemon.eggsteps=eggsteps
  else
