class PokemonTrainerCardScene
  ...
  def pbDrawTrainerCardFront
    ...
    textPositions=[
       ...
       [_INTL("${1}",pbCommaNumber($Trainer.money)),468,112,1,baseColor,shadowColor],
       [_INTL("Pokémon Found"),34,160,0,baseColor,shadowColor],
       #[_ISPRINTF("{1:d}/{2:d}",$game_variables[25],17),302,160,1,baseColor,shadowColor],
       [_ISPRINTF("{1:d}/{2:d}",$game_variables[25],18),468,160,1,baseColor,shadowColor],
       [_INTL("Time"),34,208,0,baseColor,shadowColor],
       
 # UPDATE- Adding room for 18 badges      
       #[time,302,208,1,baseColor,shadowColor]
       [time,468,208,1,baseColor,shadowColor]
    ]
